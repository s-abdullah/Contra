...
MTKG1 = rectangle('Position',[jj5 YC+25 canon canon],'facecolor','k','edgecolor','r','curvature',[1 1]);
MTKG2 = rectangle('Position',[jj6 3*YC canon canon],'facecolor','k','edgecolor','r','curvature',[1 1]);
huh = 1;
    ...
    if keyPressed == 'f'
        ...
        Bbul = yLoc(1) + bulletincre(2);
            ...
            if xLoc(2) > 3900 && M ~= 1
                ...
                set(MTKG1,'Position',[jj5 YC+25 canon canon]);
            elseif xLoc(2) > 3900 && M == 1
                jj5 = jj5 - 10;
                jj6 = jj6 - 10;
                set(MTKG1,'Position',[jj5 YC+25 canon canon]);
                set(MTKG2,'Position',[jj6 3*YC canon canon]);
            end
            if ((jj4 < 3900 && jj5 < 3900) || (jj5 < 3900 && jj6 < 3900)) && DIE < 60
                jj4 = 4650;
                jj5 = 4650;
                jj6 = 4650;
                M = mod(MM,2);
...
%         g = imagesc(im(1*h/8:2*h/8,w/8:w/8+w/8,:)); 
    ...
    if xLoc(2) > 3900 && (norm(Ux - (jj4+10)) < 20) && (norm(Uy - (25+10)) < 20)
        keyPressed = 'k';
    end
    if xLoc(2) > 3900 && (norm(Ux - (jj6+10)) < 20) && ( norm(Uy - (3*YC + 10)) < 20 )
        keyPressed = 'k';
    end
    if xLoc(2) > 3900 && (norm(Ux - (jj5+10)) < 20) && (norm(Uy - (YC + 25 + 10)) < 20)
        keyPressed = 'k';
    end
...
if keyPressed == 's'
    ...
    if xLoc(2) > 2000 && norm(Ux - jj1 + 10) < 20 && norm(Uy - YC + 10) < 20
        keyPressed = 'k';
    end
    if xLoc(2) > 2000 && norm(Ux - jj2 + 10) < 20 && norm(Uy - YC + 10) < 20
        keyPressed = 'k';
    end
    if xLoc(2) > 2000 && norm(Ux - jj3 + 10) < 20 && norm(Uy - YC + 10) < 20
        keyPressed = 'k';
    end
    
    
    if xLoc(2) > 3900 && (norm(Ux - (jj4+10)) < 20) && (norm((Uy + 15) - (25+10)) < 20)
        keyPressed = 'k';
    end
    if xLoc(2) > 3900 && (norm(Ux - (jj6+10)) < 20) && ( norm(Uy - (3*YC + 10)) < 20 )
        keyPressed = 'k';
